...
<form class="layui-form" lay-filter="layui-form" method="post">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">标示 <span class="necessary">*</span></label>
        <div class="layui-input-block">
            <input type="text" name="key" lay-verify="required" placeholder="请输入标示" autocomplete="off" class="layui-input">
        </div>
    </div>

    <div class="layui-form-item">
        <label class="layui-form-label">标题 <span class="necessary">*</span></label>
        <div class="layui-input-block">
